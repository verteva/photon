module.exports = {
  ...
  theme: {
    ...
    backgroundImage: {
      ...
      'gradient-brand1':
        'linear-gradient(180deg, #3DD6C7 0%, #009EDE 50%, #004DBD 100%)',
      'gradient-brand1h':
        'linear-gradient(90deg, #3DD6C7 0%, #009EDE 50%, #004DBD 100%)',
      'gradient-brand2': 'linear-gradient(360deg, #009EDE 0%, #03B4FC 100%)',
      'gradient-sky-up': 'linear-gradient(180deg, #264F80 0%, #AFC4D7 100%)',
      'gradient-sky-down': 'linear-gradient(180deg, #AFC4D7 0%, #264F80 100%)',
      'gradient-dark': 'linear-gradient(270deg, #1F1F1F 4.78%, #363636 100%)',
      'gradient-light-blue':
        'linear-gradient(180deg, #F1F3F6 0%, #DCE2EB 100%)',
      'gradient-light-grey':
        'linear-gradient(180deg, #FFFFFF 0%, #E6E6E6 100%)',
      'gradient-light-grey2':
        'linear-gradient(180deg, #FBFBFB 0%, #F5F5F5 100%)',
      'gradient-titanium': 'linear-gradient(180deg, #C9C9C9 0%, #535353 100%)',
      transparent: 'transparent'
    },
    ...
    boxShadow: {
      ...
      DEFAULT:
        '0 2.76px 2.21px 0 rgba(0, 0, 0, 0.02), 0 6.65px 5.32px 0 rgba(0, 0, 0, 0.03)',
      md:
    ...
    fontSize: {
      h1: ['2.188rem', { lineHeight: '1.1', letterSpacing: '-1px' }],
      h2: ['1.563rem', { lineHeight: '1.1' }],
